        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                if (_this.adapter.listenerCount(_this.targetHandlerName + _this.adapter.state) >= 1) {
                    ...
                    reject(errorUtils_1.createAskSdkError(_this.constructor.name, "In state: " + _this.adapter.state + ". No handler function was defined for event " + _this.targetHandlerName + " and no 'Unhandled' function was defined."));
                }
            }
            catch (e) {
                reject(e);

...
export declare const services: {
    DeviceAddressService: typeof DeviceAddressService;
    DirectiveService: typeof DirectiveService;
    ListManagementService: typeof ListManagementService;
};
export declare const directives: {
    VoicePlayerSpeakDirective: typeof VoicePlayerSpeakDirective;
};
export declare const templateBuilders: {
    BodyTemplate1Builder: typeof BodyTemplate1Builder;
    BodyTemplate2Builder: typeof BodyTemplate2Builder;
    BodyTemplate3Builder: typeof BodyTemplate3Builder;
    BodyTemplate6Builder: typeof BodyTemplate6Builder;
    BodyTemplate7Builder: typeof BodyTemplate7Builder;
    ListItemBuilder: typeof ListItemBuilder;
    ListTemplate1Builder: typeof ListTemplate1Builder;
    ListTemplate2Builder: typeof ListTemplate2Builder;
};
export declare const utils: {
    ImageUtils: typeof ImageUtils;
    TextUtils: typeof TextUtils;
};
export declare function handler(event: RequestEnvelope, context: any, callback?: (err: Error, result?: any) => void): Adapter;

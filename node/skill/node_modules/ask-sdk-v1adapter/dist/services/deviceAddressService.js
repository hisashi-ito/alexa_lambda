...
var DeviceAddressService = /** @class */ (function () {
    function DeviceAddressService(apiClient) {
    ...
    DeviceAddressService.prototype.getFullAddress = function (deviceId, apiEndpoint, token) {
        return __awaiter(this, void 0, void 0, function () {
            var uri, headers, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uri = apiEndpoint + this.deviceAddressPathPrefix + deviceId + this.deviceAddressPathPostfix;
    ...
    DeviceAddressService.prototype.getCountryAndPostalCode = function (deviceId, apiEndpoint, token) {
        return __awaiter(this, void 0, void 0, function () {
            var uri, headers, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uri = apiEndpoint + this.deviceAddressPathPrefix + deviceId + this.deviceAddressPathPostfix + this.countryAndPostalPathPostfix;
                        headers = [{ key: 'Authorization', value: "Bearer " + token }];
                        return [4 /*yield*/, this.apiClient.get(uri, headers)];
                    case 1:
                        response = _a.sent();
    ...
    DeviceAddressService.prototype.validateApiResponse = function (apiClientResponse) {

...
var DirectiveService = /** @class */ (function () {
    function DirectiveService(apiClient) {
        this.apiClient = apiClient || new v1ApiClient_1.V1ApiClient();
        this.directivesApiPath = '/v1/directives';
    }
    DirectiveService.prototype.enqueue = function (directive, apiEndpoint, token) {
        var uri = apiEndpoint + this.directivesApiPath;
        return this.dispatch(directive, uri, token);
    };
    DirectiveService.prototype.dispatch = function (directive, url, token) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.apiClient.post(url, headers, body)];
                    case 1:
                        response = _a.sent();
    ...
    DirectiveService.prototype.validateApiResponse = function (apiClientResponse) {
        var isResponseCodeValid = apiClientResponse.statusCode >= 200 && apiClientResponse.statusCode < 300;
        if (isResponseCodeValid) {
            return;
        }
        throw new serviceError_1.ServiceError(apiClientResponse.statusCode, JSON.stringify(apiClientResponse.body));
    };
    return DirectiveService;
}());
exports.DirectiveService = DirectiveService;
//# sourceMappingURL=directiveService.js.map